    ...
    "brain_verify_script_step": [
        {
            ...
            "instructions": [
                ...
                "branch must be one of: advance, retry, skip, goto, abort.",
                ...
                "When ActorSucceeded is false: use retry/goto/skip/abort for recovery or stop as needed; still set clearly_unmet honestly from the screenshot.",
                ...
                "Use abort to stop the whole scripted run when the step cannot be recovered (no viable retry/goto/skip) — for example ActorSucceeded is false, ExpectedOutcome is '(none)', and the goal was not achieved.",
